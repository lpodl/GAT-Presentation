...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{overpic}[trim={0 0 0 0}, width=6.3cm, height=6.77cm]{img/text_1.PNG}
            \put (25, -2.5) {\color{gray}{Rao \emph{et al.} 2021}}
           \end{overpic}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{overpic}[trim={0 0 0 0}, width=9.2cm, height=6.77cm]{img/text_3.PNG}
            \put (34.2, -2.44) {\color{gray}{Rao \emph{et al.} 2021}}
           \end{overpic}
    \end{figure}
\end{frame}
...
%    \begin{figure}
%        \centering 
%        \begin{overpic}[trim={0 0 0 5}, width=12cm, height=6.77cm]{img/benchmarks_velickovic.PNG}
%            \put (35, 0) {\color{gray}{Veličković \emph{et al.} 2018}}
%        \end{overpic}
%    \end{figure}
%\end{frame}
